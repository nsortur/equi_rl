...
from utils.drqv2RandShift import RandomShiftsAug
from utils import torch_utils

class DQNAgentComDrQv2(DQNBase):
    """
    Class for DQN (composed) agent with DrQv2 online augmentation
    """
    ...
    def calcTDLoss(self):
        ...
        # encode with drqv2 augmentation
        aug = RandomShiftsAug(pad=4)
        obs = aug(obs.float())
        next_obs = aug(next_obs.float())
